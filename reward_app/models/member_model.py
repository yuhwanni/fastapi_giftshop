...
class Member(Base):
    ...
    user_gender = Column(Enum('F', 'M', 'U'), nullable=True, comment="성별")
    user_birth = Column(String(10), nullable=True, comment="생년월일")
    solar_lunar = Column(Enum('N', 'S', 'L'), nullable=True, server_default=text("'S'"), comment="선택 안함, 양력,음력")
    ...
    del_date = Column(DateTime, nullable=True, comment="탈퇴일자")