...
class Help(Base):
    __tablename__ = "PC_HELP"

    help_seq = Column(BigInteger, nullable=False, primary_key=True, autoincrement=True, comment="도움말 순번")
    category = Column(String(200), nullable=False, comment="카테고리")
