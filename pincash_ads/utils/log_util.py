...
# 앱 전역 로거
ads_logger = setup_logger("ads_logger", "ads.log", level=logging.INFO)
db_logger = setup_logger("db_logger", "db.log", level=logging.INFO)


def log_info(message: str):
    ads_logger.info(message)


def log_error(message: str, exc_info=False):
    ads_logger.error(message, exc_info=exc_info)


def log_warning(message: str):
    ads_logger.warning(message)


def log_debug(message: str):
    ads_logger.debug(message)